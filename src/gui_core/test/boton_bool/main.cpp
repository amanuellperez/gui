...
void comprueba(const Boton_bool& b, bool v)
{
...
public:
    Ventana_main();
private:
    Boton_bool red{"red (sin presionar)"};
    Boton_bool green{"green (presionado)", true};
...
Ventana_main::Ventana_main()
    :Ventana{Size{300_pix, 300_pix}, "boton_bool"}
{
    Maquetador m{*this};
